...
/// @brief Class to convert the tokens vector to an Abstract Syntax Tree
class Compiler
{
public:
...
private:
	...
	/// @brief Gets the node type coresponding to a token type
	/// @param type The token type
	/// @return Thw coresponding node type
	...
	/// @param token The current token procesed by the algorithm
